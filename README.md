...
Hello! I am a software engineer and author living in the Pacific Northwest. I spend a lot of my free time writing and working on writing tech. You can find more of my writing over on [makyo.ink](https://makyo.ink). If you're looking to get in touch, [I got you covered](https://makyo.is).

<br clear="all" />

## Currently working on...

* [Lagrange Substations](https://lagrange14.com) ([repo](https://github.com/lagrage14/substations)) — a fork of the game Space Station 14 set in the Post-Self universe with its own play modes and evolving mechanics.
...
* [A Wildness of the Heart](https://wwildness.makyo.ink) — A novella and five short stories from Sawtooth, ID.
